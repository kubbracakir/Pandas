...
result = df
result = df["Column2"].unique()#tekrarlamayan bilgileri yazar
result = df["Column2"].nunique()#kaç tane tek olan bilgi var
result = df["Column2"].value_counts()#her elemanın kaç defa tekrarlandığını gösterir
result = df["Column1"] * 2
